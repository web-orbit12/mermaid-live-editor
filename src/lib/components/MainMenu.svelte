<script lang="ts">
  ...
  import { toggleLeftPanel } from '$/util/leftPanel';
  ...
  const menuItems: MenuItem[] = $derived([
    {
      ...
      onclick: () => toggleLeftPanel('samples'),
      renderer: panelMenuItem
    },
...
{#snippet panelMenuItem(options: MenuItem)}
  <Popover.Close
